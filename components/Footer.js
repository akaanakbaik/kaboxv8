  ...
  return (
    <footer className="w-full relative z-10 py-6 mt-auto border-t border-white/5 flex flex-col items-center justify-center gap-2 text-[10px] md:text-xs text-white/40 bg-[#050505]">
      ...
      <div className="flex gap-4 mt-2">
        <Link href="https://t.me/akamodebaik" target="_blank" className="p-2 bg-white/5 hover:bg-white/10 rounded-lg transition-colors border border-white/5 text-white/60 hover:text-white">
        ...
        <Link href="https://github.com/akaanakbaik" target="_blank" className="p-2 bg-white/5 hover:bg-white/10 rounded-lg transition-colors border border-white/5 text-white/60 hover:text-white">
