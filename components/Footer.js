    ...
    <footer className="w-full relative z-10 py-6 mt-16 border-t border-white/5 flex flex-col items-center justify-center gap-3 text-xs md:text-sm text-white/50 bg-[#0a0a0a]">
      <div className="flex items-center gap-1.5">
        ...
        <Link 
          ...
          target="_blank" 
          className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-white hover:opacity-80 transition-opacity"
        >
          aka
        </Link>
      </div>
      <div>di buat dgn ❤️ dan kode</div>
      <div className="flex gap-4 mt-2">
        <Link href="https://t.me/akamodebaik" target="_blank" className="hover:text-white transition-colors">
        ...
        <Link href="https://github.com/akaanakbaik" target="_blank" className="hover:text-white transition-colors">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
